...
class Form {
	...
	*/
    private function getErrorMessage($rule, $parameter = null) {
        ...
        $language = [
            ...
            'floatTwoPoints' => ' can only contain floating point number.',
	...
	*/
    private function numeric($value) {
     ...
     /**
	* Returns boolean if given value contains only float with 2 decimals
	*/
    private function floatTwoPoints($value) {
        if (preg_match("/^[1-9]\d*(\.\d+)?$/",$value)) return true;
        else return false;
    }
